...
class CosRec(torch.nn.Module):
    ...
    Args:
        seq_var (torch.FloatTensor): shape [batch_size, max_sequence_length]  
            A batch of sequences.
        user_var (torch.LongTensor): shape [batch_size]  
            A batch of users.
        item_var (torch.LongTensor): shape [batch_size]  
            A batch of items.
        for_pred (bool, optional):  
            Train or Prediction mode. Set to True when evaluating.
    """
