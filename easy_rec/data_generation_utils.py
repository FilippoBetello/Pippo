...
def load_item_info(dataset_raw_folder, dataset_name):   #Is it really needed?
    dataset_raw_folder = os.path.join(dataset_raw_folder, dataset_name)
    ...
    if dataset_name == "ml-100k":
        ...
        df.columns = ["movie_id", "movie_title", "release date", "video release date",
        ...
        df.columns = ["movie_id", "movie_title", *ML_genres]
        df["movie title"] = make_title_better(df["movie title"])
    else:
